    ...
    return (
      <div className="site-main">
                ...
                <div className="section-title style2 mb-0">
                  ...
                  <div className="title-desc">
                    <p>
                      ...
                      for the client employers to fulfill their companies'
                      needs. We've head quarters worldwide
                    </p>
                  </div>
                </div>
                {/* section title end */}
              ...
              <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-country">
                  ...
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      <p>
                        Our head quarters is in Canberra, help throughout
                        process
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-12">
                <div className="section-title title-style-center_text">
                  <div className="title-header">
                    <h3>
                      Find us{" "}
                      <span className="text-theme-SkinColor">here!</span>
                    </h3>
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-01.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-02.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-03.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-04.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-05.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-portfolio style1">
                  ...
                  <div className="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/680x440?text=680x440+portfolio-06.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
        ...
        <section
          ...
          style={{
            backgroundImage:
              'url("https://via.placeholder.com/1920x500?text=1920x500+row-bgimage-5.jpg")',
          }}
        >
            ...
            <div className="row">
                ...
                <div className="section-title">
                  ...
                  <div className="title-desc">
                    <p>
                      ...
                      device or desktop Manage all of the jobs you have applied
                      to from a convenience secure dashboard.
                    </p>
                  </div>
                </div>
                {/* section title end */}
                <div className="d-sm-flex social-btns">
                  <Link className="app-btn" to="http:apple.com">
                  ...
                  <Link className="app-btn" to="http:google.com">
              ...
              <div className="col-lg-6 col-sm-6 col-10 mx-auto">
                <div className="ttm_single_image-wrapper mt_20 p-15 position-absolute mb_lg-200 d-lg-block d-none">
                  <img
                    className="img-fluid"
                    src="https://via.placeholder.com/573x688?text=single-img-04-573x688.png"
                    alt="single_04"
                  />
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-11">
                ...
                <div className="section-title style2 mb-0">
                  ...
                  <div className="title-desc">
                    <p>
                      We have over 30 years experience of Financial ,Marketing
                      and Busness Solutions expertise, our goal is to maxnci
              ...
              <div className="col-lg-12">
                <div className="section-title title-style-center_text">
                  <div className="title-header">
                    <h3>
                      Get{" "}
                      <span className="text-theme-SkinColor">Forte Job!</span>
                    </h3>
              ...
              <div className="col-md-4 col-sm-6">
                ...
                <div className="featured-imagebox featured-imagebox-services style2">
                  <div className="featured-content">
                    <div className="featured-title">
                      <h3>
                        <Link to={"/services_details"}>Working Aboard</Link>
                      </h3>
                    </div>
                  </div>
                  <div className="ttm-box-view-overlay border-rad_6">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/600x600?text=600x600+services-01-1200x800.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                    <div className="featured-hover-content">
                      <div className="featured-desc">
                        <p>
                          We are specialists in botmics and information
                          tnologies and we apply our full ran
                        </p>
                      </div>
              ...
              <div className="col-md-4 col-sm-6">
                ...
                <div className="featured-imagebox featured-imagebox-services style2">
                  <div className="featured-content">
                    <div className="featured-title">
                      <h3>
                        <Link to={"/services_details"}>Casual Employees</Link>
                      </h3>
                    </div>
                  </div>
                  <div className="ttm-box-view-overlay border-rad_6">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/600x600?text=600x600+services-02-1200x800.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
              ...
              <div className="col-md-4 col-sm-6">
                ...
                <div className="featured-imagebox featured-imagebox-services style2">
                  <div className="featured-content">
                    <div className="featured-title">
                      <h3>
                        <Link to={"/services_details"}>Contract Employees</Link>
                      </h3>
                    </div>
                  </div>
                  <div className="ttm-box-view-overlay border-rad_6">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/600x600?text=600x600+services-03-1200x800.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
                ...
                <div className="featured-imagebox featured-imagebox-services style2">
                  ...
                  <div className="ttm-box-view-overlay border-rad_6">
                    ...
                    <div className="featured-thumbnail">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/600x600?text=600x600+services-04-1200x800.jpg"
                        alt="image"
                      />
                    </div>
                    {/* featured-thumbnail end */}
