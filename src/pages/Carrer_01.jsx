  ...
  render() {
    return (
      <div className="site-main">
        ...
        {/* PageHeader */}
        <PageHeader title="Carrer" breadcrumb="Carrer" />
        {/* PageHeader end */}
              ...
              <div className="col-lg-12">
                ...
                <div className="section-title style2">
                  <div className="title-header">
                    <h3>
                      popular <span className="text-theme-SkinColor">jobs</span>
                    </h3>
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12">
                      ...
                      <div className="featured-icon-box icon-align-top-content style6">
                        ...
                        <div className="featured-content">
                          ...
                          <div className="featured-desc">
                            <p>
                              This need could vary from filling a vacated
                              position, better managing a team workload, or
                              expanding.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12">
                      ...
                      <div className="featured-icon-box icon-align-top-content style6">
                        ...
                        <div className="featured-content">
                          ...
                          <div className="featured-desc">
                            <p>
                              HR department who review the applications and
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12">
                      ...
                      <div className="featured-icon-box icon-align-top-content style6">
                        ...
                        <div className="featured-content">
                          ...
                          <div className="featured-desc">
                            <p>
                              The organization and hiring committee, one or
                              several interviews are scheduled for those
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-12">
                <form
                  id="search_Form"
                  className="search_Form style2 wrap-form mt-15"
                >
                  <div className="row row-equal-height ttm-boxes-spacing-30px">
                    ...
                    <div className="col-lg-3">
                      <label>
                        <button
                          className="w-100 submit ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor ttm-icon-btn-right"
                          type="submit"
                        >
              ...
              <div className="col-lg-12">
                ...
                <div className="featured-imagebox featured-imagebox-job style2">
                  ...
                  <div className="apply-block">
                    <Link
                      className="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-dark"
                      to={"/login"}
                    >
                      Appply Now
                    </Link>
