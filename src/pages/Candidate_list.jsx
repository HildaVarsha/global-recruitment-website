  ...
  render() {
    return (
      <div className="site-main">
        ...
        {/* PageHeader */}
        <PageHeader title="candidate list" breadcrumb="candidate" />
        {/* PageHeader end */}
                      ...
                      <div className="featured-content">
                        ...
                        <div className="featured-bottom">
                          ...
                          <div className="view-block">
                            <Link
                              className="ttm-btn ttm-btn-size-sm ttm-btn-shape-rounded ttm-btn-style-border 
                                                        ttm-btn-color-dark"
                              to={"/candidate_details"}
                            >
                              view Profile
                            </Link>
                          </div>
