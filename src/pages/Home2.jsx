    ...
    description: (
      <div className="col-lg-12">
        ...
        >
          ...
          <div className="testimonial-content">
            <blockquote className="testimonial-text">
              A national award-winning staffing agency that was built with our
              trademarked tagline, Expect More, We Do. was born out of the
              desire to be better. We developed our 4-dimensional matching
              process with our clients and contractors in mind.
            </blockquote>
          </div>
        </div>
        {/* testimonials end */}
  ...
  render() {
    ...
    return (
      <div className="site-main">
              ...
              <div className="col-lg-6">
                ...
                <div className="section-title">
                  <div className="title-header">
                    ...
                    <h2 className="title">
                      Best Employment Services For Your Business
                    </h2>
                  </div>
                  <div className="title-desc">
                    <p>
                      Our dedicated group of experts assists you with meeting
                      your business objectives. We give job searchers and IT
                      experts the chance to track down ideal a profession that
                      guarantees long term development and learning.
                    </p>
                  </div>
                </div>
                {/* section title end */}
                <div className="mb-35">
                  <ul className="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor text-theme-DarkColor">
                    ...
                    <li>
                      <i className="far fa-check-circle"></i>
                      <div className="ttm-list-li-content">
                        With over 2,000 offices & thousands of recruiters
                        through overseas
                      </div>
                    </li>
                    <li>
              ...
              <div className="col-lg-6 col-md-9 col-sm-10 col-12 mx-auto">
                <div className="mr-40 ml-20 pb-60 pt-lg-50">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(https://via.placeholder.com/508x500?text=single-img-01-508x500.png)",
                      backgroundSize: "cover",
                    }}
                  >
                    <div className="pt-20 pr-20 bg-theme-WhiteColor ml_20 mb_60 mt-200">
                      <img
                        src="https://via.placeholder.com/350x290?text=single-img-02-350x290.png"
                        className="img-fluid"
                        alt="bgimage"
                      />
                    </div>
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        Make up the workforce of an organization, business firm,
                        industry, or economy
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        Specializes in recruiting executives and other personnel
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        To accelerate innovation current and future based
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        A quality personnel to the fields of expertise that
                        needed for all kind of projects
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <div className="featured-icon-box icon-align-before-title style3">
                  ...
                  <div className="featured-content">
                    <div className="featured-desc">
                      <p>
                        We do supply variety of services including fabrication,
        ...
        {/* services-section */}
        <section
          className="ttm-row services-section bg-img3 clearfix"
          style={{
            backgroundImage: 'url("images/bg-image/row-bgimage-3.png")',
          }}
        >
          <div className="container">
            {/* row */}
              ...
              <div className="col-lg-8 col-md-8">
                ...
                <div className="section-title">
                  <div className="title-header">
                    ...
                    <h2 className="title">
                      <span className="fw-normal">Recruites</span> Let’s To Work
                ...
                <div className="featuredbox-number pr-30 pr-lg-0 pb-lg-50 pt-md-20">
                  ...
                  <div className="featured-icon-box icon-align-before-content icon-ver_align-top style4">
                    ...
                    <div className="featured-content ttm-bgcolor-grey">
                      ...
                      <div className="featured-desc">
                        <p>
                          Create a list of needs before you create a job
                          posting. It may seem easy to identify a hiring need{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="featured-icon-box icon-align-before-content icon-ver_align-top style4">
                    ...
                    <div className="featured-content ttm-bgcolor-grey">
                      ...
                      <div className="featured-desc">
                        <p>
                          Save time and energy by creating the best recruitment
                          plan. To get the word out about the job
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="featured-icon-box icon-align-before-content icon-ver_align-top style4">
                    ...
                    <div className="featured-content ttm-bgcolor-grey">
                      ...
                      <div className="featured-desc">
                        <p>
                          You will need to maintain timely communication or they
                    ...
                    <div className="featured-title">
                      <h3>
                        <Link to={"/blog_details"}>
                          Are meetings falling flat? Try these 10 tips
                        </Link>
                      </h3>
                    </div>
              ...
              <div className="col-md-12">
                ...
                <div className="featured-imagebox featured-imagebox-post style2">
                  ...
                  <div className="featured-content">
                    ...
                    <div className="featured-desc">
                      <p>
                        This can be innate or external, and the results can be
                        surprising...
                      </p>
                    </div>
                    <Link
