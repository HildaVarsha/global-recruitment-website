                      ...
                      <TabPanel>
                        <div className="row">
                          ...
                          <div className="col-lg-8 col-md-9 col-sm-8">
                            <div className="pt-15">
                              <p>
                                We adapt to the our clients changing needs as
                                well changes into the market to make sure growth
                                of the business, success and happiness
                              </p>
              ...
              <div className="col-lg-12">
                ...
                <div className="section-title title-style-center_text">
                  <div className="title-header">
                    <h3>
                      Experts{" "}
                      <span className="text-theme-SkinColor">team!</span>
                    </h3>
                  ...
                  <div className="featured-media ttm-media-link">
                    <div className="media-block">
                      <ul className="social-icons list-inline">
                        <li>
                          <Link to={"/"} rel="noopener" aria-label="facebook">
                            <i className="ti ti-facebook"></i>
                          </Link>
                        </li>
                        <li>
                          <Link to={"/"} rel="noopener" aria-label="twitter">
                            <i className="ti ti-twitter-alt"></i>
                          </Link>
                        </li>
                        <li>
                          <Link to={"/"} rel="noopener" aria-label="google">
                            <i className="ti ti-google"></i>
                          </Link>
                        </li>
                        <li>
                          <Link to={"/"} rel="noopener" aria-label="linkedin">
                  ...
                  <div className="timeline">
                    ...
                    <div className="timeline-panel">
                      ...
                      <div className="timeline-body">
                        ...
                        <p>
                          Recruitment process doesn’t hinge on just one person,
                    ...
                    <div className="timeline-panel">
                      ...
                      <div className="timeline-body">
                        ...
                        <p>
                          Become leading the unique forum of exchange
                          experiences innovative solutions...
                        </p>
                      </div>
                    </div>
                    <div className="timeline-panel">
                ...
                <div className="section-title style2">
                  ...
                  <div className="title-desc">
                    <p>
                      ...
                      expertise, our goal is to maxnci reputation and financial.{" "}
                    </p>
                  </div>
                </div>
                {/* section title end */}
