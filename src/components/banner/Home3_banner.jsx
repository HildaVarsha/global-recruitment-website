      ...
      >
        <div className="slide bg-layer">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://via.placeholder.com/1920x730?text=slider-mainbg-005-1920x730.jpg)",
            }}
          ></div>
                  ...
                  <div className="d-none d-xl-block text-center position-relative">
                    <div className="z-index-1 position-relative">
                      <img
                        ...
                        src="https://via.placeholder.com/332x332?text=single01-332x332.jpg"
                      ></img>
                    </div>
                    <div className="cmp-logo one">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/210x204?text=logo1.png"
                      />
                    </div>
                    <div className="cmp-logo two">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/210x204?text=logo2.png"
                      />
                    </div>
                    <div className="cmp-logo three">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/210x204?text=logo3.png"
                      />
                    </div>
                    <div className="cmp-logo four">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/210x204?text=logo4.png"
                      />
                    </div>
                    <div className="cmp-logo five">
                      <img
                        className="img-fluid"
                        src="https://via.placeholder.com/210x204?text=logo5.png"
                      />
                    </div>
