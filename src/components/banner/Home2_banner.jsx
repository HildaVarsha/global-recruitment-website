                    ...
                    <div className="mt-20 mb-40 mb-md-15">
                      <div className="row">
                        <div className="col-xl-7 col-lg-8 col-md-10 mx-auto">
                          ...
                          >
                            We have over 30 years experience of job consultancy
                            in field of Financial, Marketing & Solutions
                            expertise our goal is to give the best job solutions
                            to the people
                          </p>
                        </div>
                      </div>
